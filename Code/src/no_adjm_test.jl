...
p = "C:\\Users\\admin\\Desktop\\Ketter-TeamAbgabe\\IS_Project_2021\\Code\\data\\outputfile E_A_negativ.csv"
α = 0.95
list=[]
beta = []
#iteration over all β between 0.0 and 1.0 in 0.05 steps
for β in collect(0.0:0.05:1) 
    rev = calc_optimazation(α,β,p,40000,40000)-calc_optimazation(α,β,p,0,40000)-calc_optimazation(α,β,p,40000,0)
    push!(list,rev)
    push!(beta,β)
end
print(list)

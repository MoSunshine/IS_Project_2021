...
Without loss of generality, we limit our analysis to a single time period 12:00 PM - 13:00 PM. Furthermore, for the sake of simplicity, we utilize the market scenario of page 220 \cite{Conejo10}. %but extend it by a second version where $E\left[\lambda^D-\lambda^A\right]<0$

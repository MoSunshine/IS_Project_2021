...
\changedByDK{This setting of a hybrid wind-solar power producer
	...
	for wind and solar power production \laura{Includen wir das nicht eher in den production quantity forecast? David: stimmt}. Therefore, we will apply the forecast for wind power production for a time $t$ in dependence on the previous times' wind speeds and previous times' solar irradiance to improve the forecast possibly. }

...
\changedByDK{This setting of a hybrid wind-solar power producer
	...
	for wind speed and solar irradiance. Therefore, we will apply the forecast for wind speed for a time $t$ in dependence on the previous times' wind speeds and previous times' solar irradiance to improve the forecast possibly. }
...
\begin{figure}[h!]
	...
	\begin{minipage}{0.8\textwidth}
		...
		\caption{The average annual profiles of solar irradiacne and wind speed \cite{}}\label{fig:overyear}
	\end{minipage}	
\end{figure}